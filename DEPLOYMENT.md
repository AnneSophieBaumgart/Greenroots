...
1. **Copiez cette URL** et remplacez `[YOUR-PASSWORD]` par le mot de passe que vous avez sauvegardé à l'étape 1.2

2. **Format final** de votre URL :

   ```
   postgresql://postgres.xxxxxxxxx:votre_mot_de_passe_fort@aws-0-eu-central-1.pooler.supabase.com:6543/postgres
   ```

3. ⚠️ **Sauvegardez cette URL complète**, vous en aurez besoin pour Render !
