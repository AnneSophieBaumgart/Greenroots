...
try {
  ...
  const trees = await Tree.bulkCreate([
    ...
    },
    {
      ...
      image: '/images/erable-a-sucre.webp', price: 20, stock: 85, origin: 'Canada'
    },
    {
